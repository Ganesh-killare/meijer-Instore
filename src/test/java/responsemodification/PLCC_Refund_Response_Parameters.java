...
public class PLCC_Refund_Response_Parameters {

	  private static Document document;

	    public PLCC_Refund_Response_Parameters(String xml) throws Exception {
		...
		public static List<String> print_PLCCRefund_Response(String[] parameters) {
