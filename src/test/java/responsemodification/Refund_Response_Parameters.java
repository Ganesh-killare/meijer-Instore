...
public class Refund_Response_Parameters {
	  private static Document document;

	    public Refund_Response_Parameters(String xml) throws Exception {
		...
		public static List<String> print_Refund_Response(String[] parameters, String transType) {
