...
public class Sale_Response_Parameters {

	private static Document document;

	public Sale_Response_Parameters(String xml) throws Exception {
	...
	public static List<String> print_Sale_Response(String trans , String[] parameters) {
