...
public class Gift_Response_Parameters {


	private static Document document;

	public Gift_Response_Parameters(String xml) throws Exception {
	...
	public static List<String> print_Gift_Response(String trans , String[] parameters) {
