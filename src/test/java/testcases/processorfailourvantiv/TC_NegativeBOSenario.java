...
public class TC_NegativeBOSenario {  
	String fileName = "W_ProcessorFailure_100.13";  
	String transType = "01"; // Change accordingly
    String transName = "sale"; // Change accordingly
    String hardCodeAmount = "100.13";
	...
	public void F_creditSale() throws Exception, Exception {    
		...
		System.out.println("PLEASE USE APPROPRIATE CARD  :: This sale is using amount "+ hardCodeAmount);
	...
	// One FSA Transaction using amount HardCode amount
	...
	// There are 1 FSA Sales (After Failour transactions should be go through wordpay)
		...
		public void P_HardCode__FSA() throws Exception, Exception {
			System.out.println("PLEASE USE FSA CARD  :: This sale is using amount "+ hardCodeAmount);
   ...
   //@Test(invocationCount = 2 , priority = 7)
		public void P_HardCode__EBT() throws Exception {
			System.out.println("PLEASE USE EBT CARD  :: This sale is using amount "+ hardCodeAmount);      
			...
			try {
				...
				String Sale_Request = EBT_Sale_Request.P_EBT_SALE_REQUEST(GCBPrameter.getParameterValue("CardToken"), transType , hardCodeAmount );  
	...
	@Test(priority = 11, dataProvider = "VoidData", dataProviderClass = TC_NegativeBOSenario.class)
	...
	// Performed 2 CREDIT OR DEBIT transaction using HardCode amount for check counter reset
	// or not

	@Test(invocationCount = 4, priority = 16)
	public void F_AfterReset_creditSale() throws Exception, Exception {
		System.out.println("PLEASE USE CREDIT CARD for the using amount  "+ hardCodeAmount);
		...
		try {
			...
			String Sale_Request = Sale_Request_Modification.P_SALE_REQUEST(
					GCBPrameter.getParameterValue("CardToken"), GCBPrameter.getParameterValue("CardIdentifier"),
					GCBPrameter.getParameterValue("CRMToken"), transType, hardCodeAmount );
