...
public class TC_ProcessorFailour17 {
	...
	List<String> headlines =  xlWriter.headlineSetter("91", "ISSUER OR SWITCH INOPERATIVE", "WORLDPAY");
		...
		public void P_HardCode__FSA() throws Exception, Exception {
			...
			try {
				...
				String Sale_Request = FSA_Sale_Request.P_FSA_SALE_Request(
						GCBPrameter.getParameterValue("CardToken"), GCBPrameter.getParameterValue("CardIdentifier"),
						GCBPrameter.getParameterValue("CRMToken"), transType, 0.17);
...
@Test(invocationCount = 1 , priority = 7)
		public void P_HardCode__EBT() throws Exception {
			...
			try {
				...
				String Sale_Request = EBT_Sale_Request.P_EBT_SALE_REQUEST(GCBPrameter.getParameterValue("CardToken"), transType, "100.17");  
	...
	// Performed 2 CREDIT OR DEBIT transaction using 100.17 for check counter reset
	// or not

	@Test(invocationCount = 4, priority = 16)
	public void F_AfterReset_creditSale() throws Exception, Exception {
		System.out.println("PLEASE USE CREDIT CARD for the using amount 100.17 ");
		...
		try {
			...
			String Sale_Request = Sale_Request_Modification.P_SALE_REQUEST(
					GCBPrameter.getParameterValue("CardToken"), GCBPrameter.getParameterValue("CardIdentifier"),
					GCBPrameter.getParameterValue("CRMToken"), transType, "100.17");
