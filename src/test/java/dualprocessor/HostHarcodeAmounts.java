...
public class HostHarcodeAmounts extends BaseClass {

	String fileName = "ProcessorFailure";
	...
	public void setUp() throws Exception, InterruptedException, Exception {
		...
		List<String> expectedList = xlWriter.generateTransactionSteps(ResponseCode, 0);
	...
	public void PF_performCreditDebit() throws IOException, InterruptedException, Exception {
		...
		System.out.println("Hardcode Amount Credit / Debit Sale ");

		try {
			List<String> saleData = PR_performCreditDebitSale(Amount, transType);

			List<String> expectedList = xlWriter.generateTransactionSteps(ResponseCode, invocationCount);
	...
	@Test(invocationCount = 2, priority = 18)
