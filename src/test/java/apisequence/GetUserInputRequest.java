...
public class GetUserInputRequest {
	public static String getUserInputRequest() throws JDOMException, IOException {

		File xmlFile = new File("./src\\test\\resources\\API sequence\\GetUserInput.xml");
