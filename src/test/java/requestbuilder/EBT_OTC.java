...
public class EBT_OTC {
	...
	public static String RW_SALE_REQUEST(String CardToken, String CI, String CRM) {
	...
	public static String SaleRequest(String CardToken, String CI, String CRM, String amount) {
		try {
