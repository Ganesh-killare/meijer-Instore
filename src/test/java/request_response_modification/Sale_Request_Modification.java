...
public class Sale_Request_Modification {
	...
	public static String modified_Sale_Request(String cardToken, String cardIdentifier, String CRMToken,
			String transType) {
		...
		try {
			...
			Document doc = saxBuilder.build("D:\\Eclipse\\CCT_TESTING\\src\\test\\resources\\credit_debit\\sale.xml");
