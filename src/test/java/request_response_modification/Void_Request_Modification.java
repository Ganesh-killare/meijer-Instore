...
public class Void_Request_Modification {

	public static String modified_Void_Request(String transType , String amount, String AuruspayTicketNumber, String TransactionID) {

		try {
			// Load the XML file
			SAXBuilder saxBuilder = new SAXBuilder();
			Document doc = saxBuilder.build("D:\\Eclipse\\CCT_TESTING\\src\\test\\resources\\credit_debit\\Void.xml");
