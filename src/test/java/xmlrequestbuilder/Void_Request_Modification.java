...
public class Void_Request_Modification {
	...
	public static String modified_Void_Request(String transType, String amount, String AuruspayTicketNumber,
		...
		try {
			...
			Document doc = saxBuilder.build("./src\\test\\resources\\credit_debit\\Void.xml");
