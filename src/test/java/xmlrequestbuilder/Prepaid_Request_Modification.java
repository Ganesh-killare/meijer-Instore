...
public class Prepaid_Request_Modification {
	...
	public static String modified_Prepaid_Request(String amount, String cardNumber, String EntrySource,
		...
		try {
			...
			Document doc = saxBuilder.build("./src\\test\\resources\\Gift\\Prepaid.xml");
	...
	public static String modified_Prepaid_Request2(String amount, String cardNumber, String EntrySource,
			String SubTransType, String transtype, String Upc , String CI) {
		...
		try {
			...
			root.getChild("TransactionType").setText(transtype);
			root.getChild("ECOMMInfo").getChild("CardIdentifier").setText(CI);
